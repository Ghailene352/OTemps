...
class SecurityController extends AbstractController
{
    ...
    public function login(Request $request, EntityManagerInterface $em, UserPasswordHasherInterface $hasher, UserAuthenticatorInterface $userAuthenticator): Response
    {
        if ($request->isMethod('POST')) {
            ...
            if (!$user) {
                ...
                // Connexion Symfony
                $userAuthenticator->authenticateUser($user, $this->container->get('security.authenticator.form_login.main'), $request);
    ...
    public function faceLogin(Request $request, EntityManagerInterface $em, UserAuthenticatorInterface $userAuthenticator): JsonResponse
    {
...
public function forgotPassword(Request $request, EntityManagerInterface $em): Response
{
    ...
    $form = $this->createFormBuilder()
        ...
        ->add('send', SubmitType::class, ['label' => 'Envoyer le code'])
        ->getForm();
    ...
    public function resetPassword(Request $request, EntityManagerInterface $em, UserPasswordHasherInterface $hasher): Response
    {
        ...
        $form = $this->createFormBuilder()
            ...
            ->add('reset', SubmitType::class,['label'=>'Réinitialiser'])
            ->getForm();
